...
main(){
  testWidgets("Pressure page should contains widgets", (WidgetTester tester) async {
    await tester.pumpWidget(
        TestHelper.wrapWidgetWithLocalizationApp(WeatherForecastPressurePage(setupWeatherForecastHolder(), 300, 100)));
    ...
    expect(
        find.byKey(Key("weather_forecast_pressure_page_subtitle")), findsOneWidget);
    ...
    RichText subtitle =
    tester.widget(find.byKey(Key("weather_forecast_pressure_page_subtitle")));
    ...
    Row bottomRow =
    tester.widget(find.byKey(Key("weather_forecast_pressure_page_bottom_row")));
